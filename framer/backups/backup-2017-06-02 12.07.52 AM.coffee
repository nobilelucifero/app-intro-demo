...
msgTwo.html = 'Choose from tours and attractions all over the world'
...
msgThree.html = 'Keep it simple with hassle-free ticketing on your mobile'
...
if !screenIsTooTiny
	...
	deckRowOne.states.switchState("default");
